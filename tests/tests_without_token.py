...
@pytest.mark.parametrize('booking_id, expected_status, headers', [
    (1, 200, {"Accept": "application/json"}),       # Действительный booking_id и заголовок, положительный тест
    (0, 404, {"Accept": "application/json"}),       # Недействительный booking_id, негативный тест
    (-1, 404, {"Accept": "application/json"}),      # Недействительный booking_id, негативный тест
    ('a', 404, {"Accept": "application/json"}),     # Недействительный booking_id, негативный тест
    (1, 418, {"Accept": ""}),                       # Негативный тест
    (1, 200, None)])                                # Негативный тест
